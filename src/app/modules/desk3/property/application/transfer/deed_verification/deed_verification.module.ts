...
import { DeedVerificationRoutes } from 'app/modules/desk3/property/application/transfer/deed_verification/deed_verification.routing';
...
export class Desk3DeedVerificationTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
