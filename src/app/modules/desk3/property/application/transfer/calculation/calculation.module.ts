...
import { CalculationRoutes } from 'app/modules/desk3/property/application/transfer/calculation/calculation.routing';
...
export class Desk3CalculationTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
