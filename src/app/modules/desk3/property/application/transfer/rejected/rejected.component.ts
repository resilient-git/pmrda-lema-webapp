...
import { RejectedService } from 'app/modules/desk3/property/application/transfer/rejected/rejected.service';
...
import { Desk3RejectedTransferModule } from "./rejected.module";
...
export class RejectedComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<Desk3RejectedTransferModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<Desk3RejectedTransferModule>;
  ...
  ngOnInit(): void {
   ...
   let user = cloneDeep(JSON.parse(localStorage.getItem('currentUser')));
    ...
    const code = user.id;
    this._rejectedService.getRejectedDesk3()
      .subscribe(() => {
