...
import { ViewPropertyTransferVerifyService } from 'app/modules/desk3/property/application/transfer/pending/details/verify/verify.service';
import { MastersService } from 'app/modules/admin/masters/masters.service';
import { FuseAlertType } from '@fuse/components/alert';
import { MatDialog } from '@angular/material/dialog';
import { MatTable, MatTableDataSource } from "@angular/material/table";
import{ ViewPropertyTransferVerifyModule } from 'app/modules/desk3/property/application/transfer/pending/details/verify/verify.module'
  ...
  */
  ...
  if(this.approveForm && this.approveForm.value){
   ...
   // this.propertyTransferForm.value.user_property_code = this._activatedRoute.params['_value'].code;
    ...
    this._viewPropertyTransferVerifyService.approveDesk3(this.approveForm.value)
        .subscribe((response) => {
            if (response.status != 200) {
               ...
               this._router.navigateByUrl('/desk3/pending-transfer-applications');
