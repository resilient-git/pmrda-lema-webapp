...
import { FeesPaymentDoneRoutes } from 'app/modules/joint-commissioner/payment/fees/done/payment-done.routing';
...
export class JointCommissionerFeesPaymentDoneModule
{
}