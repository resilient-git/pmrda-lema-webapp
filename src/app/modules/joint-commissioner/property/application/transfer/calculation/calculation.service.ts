...
export class CalculationService
{
    ...
    getCalculationJointCommissioner(): Observable<any>
    {
        let url = this.apiEndPoint + 'joint-commissioner/transfer-calculation';
    ...
    getCalculationJointCommissioner1(code): Observable<any>
    {
