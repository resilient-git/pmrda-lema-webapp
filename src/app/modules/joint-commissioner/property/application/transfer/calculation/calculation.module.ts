...
import { CalculationRoutes } from 'app/modules/joint-commissioner/property/application/transfer/calculation/calculation.routing';
...
export class JointCommissionerCalculationTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
