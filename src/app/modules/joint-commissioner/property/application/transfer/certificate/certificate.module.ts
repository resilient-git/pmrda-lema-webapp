...
import { CertificateRoutes } from 'app/modules/joint-commissioner/property/application/transfer/certificate/certificate.routing';
...
export class JointCommissionerCertificateTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
