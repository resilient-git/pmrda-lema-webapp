...
export class DeedVerificationService
{
    ...
    getDeedVerificationJointCommissioner(): Observable<any>
    {
        let url = this.apiEndPoint + 'joint-commissioner/transfer-applications/deed-verify-pending';
    ...
    getDeedVerificationJointCommissioner1(code): Observable<any>
    {
