...
import { RejectedRoutes } from 'app/modules/joint-commissioner/property/application/transfer/rejected/rejected.routing';
...
export class JointCommissionerRejectedTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
