...
import { PendingService } from 'app/modules/joint-commissioner/property/application/transfer/pending/pending.service';
...
import { JointCommissionerPendingTransferModule } from "./pending.module";
...
export class PendingComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<JointCommissionerPendingTransferModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<JointCommissionerPendingTransferModule>;
  ...
  ngOnInit(): void {
   ...
   let user = cloneDeep(JSON.parse(localStorage.getItem('currentUser')));
    ...
    const code = user.id;
    this._pendingService.getPendingJointCommissioner()
      .subscribe(() => {
