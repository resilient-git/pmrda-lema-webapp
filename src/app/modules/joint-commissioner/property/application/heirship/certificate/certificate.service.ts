...
export class CertificateService
{
    ...
    {
        let url = this.apiEndPoint + 'joint-commissioner/heirship-applications/certificate-pending';
    ...
    getCertificateJointCommissioner1(code): Observable<any>
    {
       ...
       // let url = this.apiEndPoint + 'joint-commissioner/heirship-applications/'+code;
        return this._httpClient.get(url).pipe(
            tap((response: any) => {
                this._data.next(response);
