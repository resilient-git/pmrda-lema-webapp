  ...
  */
  ...
  if(this.approveForm && this.approveForm.value){
   ...
   // this.BankNocTransferForm.value.user_BankNoc_code = this._activatedRoute.params['_value'].code;
    ...
    this._viewBankNocTransferActionService.verifyJointCommissioner(this.approveForm.value)
        .subscribe((response) => {
            if (response.status != 200) {
               ...
               this._router.navigateByUrl('/joint-commissioner/banknoc-applications/verification-pending');
...
sendRejection(): void {
  ...
  // this.BankNocTransferForm.value.user_BankNoc_code = this._activatedRoute.params['_value'].code;
    ...
    this._viewBankNocTransferActionService.rejectJointCommissioner(this.rejectForm.value)
        .subscribe((response) => {
            if (response.status != 200) {
                // Re-enable the form
              ...
              this._router.navigateByUrl('/joint-commissioner/verification-transfer-applications');
