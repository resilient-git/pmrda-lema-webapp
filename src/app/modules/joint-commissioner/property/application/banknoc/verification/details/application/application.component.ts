...
import { ViewBankNocTransferApplicationService } from 'app/modules/joint-commissioner/property/application/banknoc/verification/details/application/application.service';
import { MastersService } from 'app/modules/admin/masters/masters.service';
import { FuseAlertType } from '@fuse/components/alert';
import { MatDialog } from '@angular/material/dialog';
import { MatTable, MatTableDataSource } from "@angular/material/table";
import{ ViewBankNocTransferApplicationModule } from 'app/modules/joint-commissioner/property/application/banknoc/verification/details/application/application.module'
@Component({
