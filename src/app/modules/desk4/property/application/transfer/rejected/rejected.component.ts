...
import { RejectedService } from 'app/modules/desk4/property/application/transfer/rejected/rejected.service';
...
import { Desk4RejectedTransferModule } from "./rejected.module";
...
export class RejectedComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<Desk4RejectedTransferModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<Desk4RejectedTransferModule>;
  ...
  ngOnInit(): void {
   ...
   let user = cloneDeep(JSON.parse(localStorage.getItem('currentUser')));
    ...
    const code = user.id;
    this._rejectedService.getRejectedDesk4()
      .subscribe(() => {
