...
import { VerificationRoutes } from 'app/modules/desk4/property/application/transfer/verification/verification.routing';
...
export class Desk4VerificationTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
