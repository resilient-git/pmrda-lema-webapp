...
import { AppointmentService } from 'app/modules/desk4/property/application/transfer/appointment/appointment.service';
...
import { Desk4AppointmentTransferModule } from "./appointment.module";
...
export class AppointmentComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<Desk4AppointmentTransferModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<Desk4AppointmentTransferModule>;
    ...
    this.__appointmentService.approveDesk4(this.approveForm.value)
        .subscribe((response) => {
            if (response.status != 200) {
               ...
               this._router.navigateByUrl('/desk4/appointment-transfer-applications');
