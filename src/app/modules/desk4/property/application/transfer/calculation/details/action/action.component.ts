...
import { ViewPropertyTransferActionService } from 'app/modules/desk4/property/application/transfer/calculation/details/action/action.service';
import { MastersService } from 'app/modules/admin/masters/masters.service';
import { FuseAlertType } from '@fuse/components/alert';
import { MatDialog } from '@angular/material/dialog';
import { MatTable, MatTableDataSource } from "@angular/material/table";
import{ ViewPropertyTransferActionModule } from 'app/modules/desk4/property/application/transfer/calculation/details/action/action.module'
@Component({
  ...
  */
  ...
  if(this.approveForm && this.approveForm.value){
   ...
   // this.propertyTransferForm.value.user_property_code = this._activatedRoute.params['_value'].code;
    ...
    this._viewPropertyTransferActionService.approveTransferFeeDesk4(this.approveForm.value)
        .subscribe((response) => {
            if (response.status != 200) {
               ...
               this._router.navigateByUrl('/desk4/transfer-applications/calculation-pending');
    ...
    this._viewPropertyTransferActionService.rejectDesk4(this.rejectForm.value)
        .subscribe((response) => {
            if (response.status != 200) {
              ...
              this._router.navigateByUrl('/desk4/calculation-transfer-applications');
