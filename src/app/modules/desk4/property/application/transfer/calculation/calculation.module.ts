...
import { CalculationRoutes } from 'app/modules/desk4/property/application/transfer/calculation/calculation.routing';
...
export class Desk4CalculationTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
