...
export class DeedVerificationService
{
    ...
    getDeedVerificationDesk4(): Observable<any>
    {
        let url = this.apiEndPoint + 'desk4/transfer-applications/deed-verify-pending';
    ...
    getDeedVerificationDesk41(code): Observable<any>
    {
