...
import { VerificationService } from 'app/modules/desk4/property/application/heirship/verification/verification.service';
...
import { Desk4VerificationHeirshipModule } from "./verification.module";
...
export class VerificationComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<Desk4VerificationHeirshipModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<Desk4VerificationHeirshipModule>;
    ...
    this.__verificationService.approveDesk4(this.approveForm.value)
        .subscribe((response) => {
            if (response.status != 200) {
               ...
               this._router.navigateByUrl('/desk4/verification-heirship-applications');
