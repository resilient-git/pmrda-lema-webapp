...
export class CertificateService
{
    ...
    getCertificateDesk4(): Observable<any>
    {
        let url = this.apiEndPoint + 'desk4/heirship-applications/certificate-pending';
    ...
    getCertificateDesk41(code): Observable<any>
    {
        
        let url = this.apiEndPoint + 'properties/list';
       // let url = this.apiEndPoint + 'desk4/heirship-applications/'+code;
        return this._httpClient.get(url).pipe(
            tap((response: any) => {
                this._data.next(response);
