...
import { PendingService } from 'app/modules/desk4/property/application/transfer/pending/pending.service';
...
import { Desk4PendingTransferModule } from "./pending.module";
...
export class PendingComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<Desk4PendingTransferModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<Desk4PendingTransferModule>;
  ...
  ngOnInit(): void {
   ...
   let user = cloneDeep(JSON.parse(localStorage.getItem('currentUser')));
    ...
    const code = user.id;
    this._pendingService.getPendingDesk4()
      .subscribe(() => {
