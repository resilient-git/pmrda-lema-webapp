...
import { AppointmentRoutes } from 'app/modules/desk4/property/application/banknoc/transfer/appointment/appointment.routing';
...
export class Desk4AppointmentTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
