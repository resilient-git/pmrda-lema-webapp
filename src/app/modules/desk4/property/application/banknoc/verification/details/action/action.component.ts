...
import { ViewBankNocTransferActionService } from 'app/modules/desk4/property/application/banknoc/verification/details/action/action.service';
import { MastersService } from 'app/modules/admin/masters/masters.service';
import { FuseAlertType } from '@fuse/components/alert';
import { MatDialog } from '@angular/material/dialog';
import { MatTable, MatTableDataSource } from "@angular/material/table";
import{ ViewBankNocTransferActionModule } from 'app/modules/desk4/property/application/banknoc/verification/details/action/action.module'
@Component({
  ...
  */
  ...
  if(this.approveForm && this.approveForm.value){
   ...
   // this.BankNocTransferForm.value.user_BankNoc_code = this._activatedRoute.params['_value'].code;
    ...
    this._viewBankNocTransferActionService.verifyDesk4(this.approveForm.value)
        .subscribe((response) => {
            if (response.status != 200) {
               ...
               this._router.navigateByUrl('/desk4/banknoc-applications/verification-pending');
...
sendRejection(): void {
  ...
  // this.BankNocTransferForm.value.user_BankNoc_code = this._activatedRoute.params['_value'].code;
    ...
    this._viewBankNocTransferActionService.rejectDesk4(this.rejectForm.value)
        .subscribe((response) => {
            if (response.status != 200) {
                // Re-enable the form
