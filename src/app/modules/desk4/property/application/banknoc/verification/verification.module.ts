...
import { VerificationBankNocRoutes } from 'app/modules/desk4/property/application/banknoc/verification/verification.routing';
...
export class Desk4VerificationBankNocTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
