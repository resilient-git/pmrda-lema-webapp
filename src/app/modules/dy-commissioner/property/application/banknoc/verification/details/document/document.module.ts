...
import { ViewBankNocTransferDocumentRoutes } from 'app/modules/dy-commissioner/property/application/banknoc/verification/details/document/document.routing';
...
@NgModule({
    declarations: [
       // DndDirective,
        //ProgressComponent,
        ViewBankNocTransferDocumentComponent
    ],
    imports     : [
        RouterModule.forChild(ViewBankNocTransferDocumentRoutes),
        MatButtonModule,
...
export class ViewBankNocTransferDocumentModule
{
    id:number;
    first_name:string;
    middle_name:string;
