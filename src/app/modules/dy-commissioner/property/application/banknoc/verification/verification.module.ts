...
import { VerificationBankNocRoutes } from 'app/modules/dy-commissioner/property/application/banknoc/verification/verification.routing';
...
@NgModule({
    declarations: [
        VerificationBankNocComponent
    ],
    imports     : [
        RouterModule.forChild(VerificationBankNocRoutes),
        MatButtonModule,
...
export class DyCommissionerVerificationBankNocTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
