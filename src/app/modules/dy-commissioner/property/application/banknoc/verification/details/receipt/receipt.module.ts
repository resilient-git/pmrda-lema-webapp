...
import { ViewBankNocTransferReceiptRoutes } from 'app/modules/dy-commissioner/property/application/banknoc/verification/details/receipt/receipt.routing';
...
@NgModule({
    declarations: [
       // DndDirective,
        //ProgressComponent,
        ViewBankNocTransferReceiptComponent
    ],
    imports     : [
        RouterModule.forChild(ViewBankNocTransferReceiptRoutes),
        MatButtonModule,
...
export class ViewBankNocTransferReceiptModule
{
    id:number;
    first_name:string;
    middle_name:string;
