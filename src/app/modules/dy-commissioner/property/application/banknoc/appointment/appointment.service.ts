...
export class AppointmentService
{
    ...
    getAppointmentDyCommissioner(): Observable<any>
    {
        let url = this.apiEndPoint + 'dy-commissioner/transfer-appointment';
    ...
    getAppointmentDyCommissioner1(code): Observable<any>
    {
