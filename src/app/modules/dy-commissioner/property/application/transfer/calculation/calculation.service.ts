...
export class CalculationService
{
    ...
    getCalculationDyCommissioner(): Observable<any>
    {
        let url = this.apiEndPoint + 'dy-commissioner/transfer-calculation';
    ...
    getCalculationDyCommissioner1(code): Observable<any>
    {
