...
import { DeedVerificationRoutes } from 'app/modules/dy-commissioner/property/application/transfer/deed_verification/deed_verification.routing';
...
export class DyCommissionerDeedVerificationTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
