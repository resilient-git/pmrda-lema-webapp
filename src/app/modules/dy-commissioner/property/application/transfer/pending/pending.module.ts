...
import { PendingRoutes } from 'app/modules/dy-commissioner/property/application/transfer/pending/pending.routing';
...
export class DyCommissionerPendingTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
