...
import { ViewPropertyTransferActionService } from 'app/modules/dy-commissioner/property/application/transfer/pending/details/action/action.service';
import { MastersService } from 'app/modules/admin/masters/masters.service';
import { FuseAlertType } from '@fuse/components/alert';
import { MatDialog } from '@angular/material/dialog';
import { MatTable, MatTableDataSource } from "@angular/material/table";
import{ ViewPropertyTransferActionModule } from 'app/modules/dy-commissioner/property/application/transfer/pending/details/action/action.module'
@Component({
    ...
    this._viewPropertyTransferActionService.approveDyCommissioner(this.approveForm.value)
        .subscribe((response) => {
            if (response.status != 200) {
               ...
               this._router.navigateByUrl('/dy-commissioner/pending-transfer-applications');
