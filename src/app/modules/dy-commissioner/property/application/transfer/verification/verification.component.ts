...
import { VerificationService } from 'app/modules/dy-commissioner/property/application/transfer/verification/verification.service';
...
import { DyCommissionerVerificationTransferModule } from "./verification.module";
...
export class VerificationComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<DyCommissionerVerificationTransferModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<DyCommissionerVerificationTransferModule>;
