...
export class VerificationService
{
    ...
    getVerificationDyCommissioner(): Observable<any>
    {
        let url = this.apiEndPoint + 'dy-commissioner/transfer-verification';
    ...
    getVerificationDyCommissioner1(code): Observable<any>
    {
