...
import { VerificationRoutes } from 'app/modules/dy-commissioner/property/application/transfer/verification/verification.routing';
...
export class DyCommissionerVerificationTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
