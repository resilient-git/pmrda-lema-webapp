...
import { CertificateService } from 'app/modules/dy-commissioner/property/application/transfer/certificate/certificate.service';
...
import { DyCommissionerCertificateTransferModule } from "./certificate.module";
...
export class CertificateComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<DyCommissionerCertificateTransferModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<DyCommissionerCertificateTransferModule>;
