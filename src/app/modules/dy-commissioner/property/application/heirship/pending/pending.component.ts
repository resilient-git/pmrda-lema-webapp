...
import { PendingService } from 'app/modules/dy-commissioner/property/application/transfer/pending/pending.service';
...
import { DyCommissionerPendingTransferModule } from "./pending.module";
...
export class PendingComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<DyCommissionerPendingTransferModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<DyCommissionerPendingTransferModule>;
  ...
  ngOnInit(): void {
   ...
   let user = cloneDeep(JSON.parse(localStorage.getItem('currentUser')));
    ...
    const code = user.id;
    this._pendingService.getPendingDyCommissioner()
      .subscribe(() => {
