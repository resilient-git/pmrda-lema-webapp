...
import { DyCommissionerAppointmentHeirshipModule } from "./appointment.module";
...
export class AppointmentComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<DyCommissionerAppointmentHeirshipModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<DyCommissionerAppointmentHeirshipModule>;
    ...
    this.__appointmentService.approveDyCommissioner(this.approveForm.value)
        .subscribe((response) => {
            if (response.status != 200) {
               ...
               this._router.navigateByUrl('/dy-commissioner/appointment-heirship-applications');
