...
import{ ViewPropertyHeirshipDocumentModule } from 'app/modules/dy-commissioner/property/application/heirship/verification/details/document/document.module'
@Component({
