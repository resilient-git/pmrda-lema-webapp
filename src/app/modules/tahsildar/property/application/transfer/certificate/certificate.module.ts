...
import { CertificateRoutes } from 'app/modules/tahsildar/property/application/transfer/certificate/certificate.routing';
...
export class TahsildarCertificateTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
