...
import { DeedVerificationRoutes } from 'app/modules/tahsildar/property/application/transfer/deed_verification/deed_verification.routing';
...
export class TahsildarDeedVerificationTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
