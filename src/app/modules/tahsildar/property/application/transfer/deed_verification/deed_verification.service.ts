...
export class DeedVerificationService
{
    ...
    getDeedVerificationTahsildar(): Observable<any>
    {
        let url = this.apiEndPoint + 'tahsildar/transfer-applications/deed-verify-pending';
    ...
    getDeedVerificationTahsildar1(code): Observable<any>
    {
