...
import { CalculationRoutes } from 'app/modules/tahsildar/property/application/transfer/calculation/calculation.routing';
...
export class TahsildarCalculationTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
