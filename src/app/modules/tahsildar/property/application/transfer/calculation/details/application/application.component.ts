...
import { ViewPropertyTransferApplicationService } from 'app/modules/tahsildar/property/application/transfer/calculation/details/application/application.service';
import { MastersService } from 'app/modules/admin/masters/masters.service';
import { FuseAlertType } from '@fuse/components/alert';
import { MatDialog } from '@angular/material/dialog';
import { MatTable, MatTableDataSource } from "@angular/material/table";
import{ ViewPropertyTransferApplicationModule } from 'app/modules/tahsildar/property/application/transfer/calculation/details/application/application.module'
@Component({
