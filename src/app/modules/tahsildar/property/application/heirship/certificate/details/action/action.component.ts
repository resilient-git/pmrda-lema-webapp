...
import{ ViewPropertyHeirshipActionModule } from 'app/modules/tahsildar/property/application/heirship/certificate/details/action/action.module'
@Component({
  ...
  */
  ...
  if(this.approveForm && this.approveForm.value){
   ...
   // this.propertyHeirshipForm.value.user_property_code = this._activatedRoute.params['_value'].code;
    ...
    this._viewPropertyHeirshipActionService.approveTahsildar(this.approveForm.value)
        .subscribe((response) => {
            if (response.status != 200) {
               ...
               this._router.navigateByUrl('/tahsildar/heirship-applications/certificate-pending');
