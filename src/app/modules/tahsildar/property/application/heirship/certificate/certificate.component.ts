...
import { CertificateService } from 'app/modules/tahsildar/property/application/heirship/certificate/certificate.service';
...
import { TahsildarCertificateHeirshipModule } from "./certificate.module";
...
export class CertificateComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<TahsildarCertificateHeirshipModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<TahsildarCertificateHeirshipModule>;
    ...
    this.__certificateService.approveTahsildar(this.approveForm.value)
        .subscribe((response) => {
            if (response.status != 200) {
               ...
               this._router.navigateByUrl('/tahsildar/certificate-heirship-applications');
