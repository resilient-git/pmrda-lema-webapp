...
import { VerificationService } from 'app/modules/tahsildar/property/application/heirship/verification/verification.service';
...
import { TahsildarVerificationHeirshipModule } from "./verification.module";
...
export class VerificationComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<TahsildarVerificationHeirshipModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<TahsildarVerificationHeirshipModule>;
    ...
    this.__verificationService.approveTahsildar(this.approveForm.value)
        .subscribe((response) => {
            if (response.status != 200) {
               ...
               this._router.navigateByUrl('/tahsildar/verification-heirship-applications');
