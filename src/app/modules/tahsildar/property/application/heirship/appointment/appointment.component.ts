...
import { AppointmentService } from 'app/modules/tahsildar/property/application/heirship/appointment/appointment.service';
...
import { TahsildarAppointmentHeirshipModule } from "./appointment.module";
...
export class AppointmentComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<TahsildarAppointmentHeirshipModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<TahsildarAppointmentHeirshipModule>;
    ...
    this.__appointmentService.approveTahsildar(this.approveForm.value)
        .subscribe((response) => {
            if (response.status != 200) {
               ...
               this._router.navigateByUrl('/tahsildar/appointment-heirship-applications');
