...
import { ViewBankNocTransferReceiptService } from 'app/modules/tahsildar/property/application/banknoc/verification/details/receipt/receipt.service';
import { MastersService } from 'app/modules/admin/masters/masters.service';
import { FuseAlertType } from '@fuse/components/alert';
import { MatDialog } from '@angular/material/dialog';
import { MatTable, MatTableDataSource } from "@angular/material/table";
import{ ViewBankNocTransferReceiptModule } from 'app/modules/tahsildar/property/application/banknoc/verification/details/receipt/receipt.module'
@Component({
    selector       : 'ViewBankNocTransferReceipt',
...
export class ViewBankNocTransferReceiptComponent implements OnInit
{
    ...
    pta : any;
    dataSource: MatTableDataSource<ViewBankNocTransferReceiptModule> = new MatTableDataSource([]);
    displayedColumns: string[] = ['srno','purchaser_name','receipts'];
    /**
     * Constructor
     */
    constructor(
        private _viewBankNocTransferReceiptService: ViewBankNocTransferReceiptService,
