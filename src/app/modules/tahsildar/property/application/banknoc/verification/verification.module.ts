...
import { VerificationBankNocRoutes } from 'app/modules/tahsildar/property/application/banknoc/verification/verification.routing';
...
export class TahsildarVerificationBankNocTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
