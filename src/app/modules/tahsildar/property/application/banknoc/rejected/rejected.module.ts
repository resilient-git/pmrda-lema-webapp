...
import { RejectedRoutes } from 'app/modules/tahsildar/property/application/banknoc/transfer/rejected/rejected.routing';
...
export class TahsildarRejectedTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
