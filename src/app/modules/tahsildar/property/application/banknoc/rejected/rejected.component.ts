...
import { RejectedService } from 'app/modules/tahsildar/property/application/banknoc/transfer/rejected/rejected.service';
...
import { TahsildarRejectedTransferModule } from "./rejected.module";
...
export class RejectedComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<TahsildarRejectedTransferModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<TahsildarRejectedTransferModule>;
  ...
  ngOnInit(): void {
   ...
   let user = cloneDeep(JSON.parse(localStorage.getItem('currentUser')));
    ...
    const code = user.id;
    this._rejectedService.getRejectedTahsildar()
      .subscribe(() => {
