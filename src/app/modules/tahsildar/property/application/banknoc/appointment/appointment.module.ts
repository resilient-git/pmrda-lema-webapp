...
import { AppointmentRoutes } from 'app/modules/tahsildar/property/application/banknoc/transfer/appointment/appointment.routing';
...
export class TahsildarAppointmentTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
