...
export class CertificateService
{
    ...
    {
        let url = this.apiEndPoint + 'financial-controller/heirship-applications/certificate-pending';
    ...
    getCertificateFinancialController1(code): Observable<any>
    {
       ...
       // let url = this.apiEndPoint + 'financial-controller/heirship-applications/'+code;
        return this._httpClient.get(url).pipe(
            tap((response: any) => {
                this._data.next(response);
