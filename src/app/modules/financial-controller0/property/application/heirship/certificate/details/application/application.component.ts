...
import{ ViewPropertyHeirshipApplicationModule } from 'app/modules/financial-controller/property/application/heirship/certificate/details/application/application.module'
@Component({
