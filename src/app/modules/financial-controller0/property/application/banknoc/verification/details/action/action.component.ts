...
import { ViewBankNocTransferActionService } from './action.service';
import { MastersService } from 'app/modules/admin/masters/masters.service';
import { FuseAlertType } from '@fuse/components/alert';
import { MatDialog } from '@angular/material/dialog';
import { MatTable, MatTableDataSource } from "@angular/material/table";
import{ ViewBankNocTransferActionModule } from './action.module'
@Component({
  ...
  */
  ...
  if(this.approveForm && this.approveForm.value){
   ...
   // this.BankNocTransferForm.value.user_BankNoc_code = this._activatedRoute.params['_value'].code;
    ...
    this._viewBankNocTransferActionService.verifyFinancialController(this.approveForm.value)
        .subscribe((response) => {
            if (response.status != 200) {
               ...
               this._router.navigateByUrl('/financial-controller/banknoc-applications/verification-pending');
...
sendRejection(): void {
  ...
  // this.BankNocTransferForm.value.user_BankNoc_code = this._activatedRoute.params['_value'].code;
    ...
    this._viewBankNocTransferActionService.rejectFinancialController(this.rejectForm.value)
        .subscribe((response) => {
            if (response.status != 200) {
                // Re-enable the form
              ...
              this._router.navigateByUrl('/financial-controller/verification-transfer-applications');
