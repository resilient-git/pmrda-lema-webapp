...
import { ViewBankNocTransferApplicationService } from 'app/modules/financial-controller/property/application/banknoc/verification/details/application/application.service';
import { MastersService } from 'app/modules/admin/masters/masters.service';
import { FuseAlertType } from '@fuse/components/alert';
import { MatDialog } from '@angular/material/dialog';
import { MatTable, MatTableDataSource } from "@angular/material/table";
import{ ViewBankNocTransferApplicationModule } from 'app/modules/financial-controller/property/application/banknoc/verification/details/application/application.module'
@Component({
    selector       : 'ViewBankNocTransferApplication',
...
export class ViewBankNocTransferApplicationComponent implements OnInit
{
    ...
    pta : any;
    dataSource: MatTableDataSource<ViewBankNocTransferApplicationModule> = new MatTableDataSource([]);
    displayedColumns: string[] = ['id','first_name','middle_name','last_name','email','mobile'];
    /**
     * Constructor
     */
    constructor(
        private _viewBankNocTransferApplicationService: ViewBankNocTransferApplicationService,
