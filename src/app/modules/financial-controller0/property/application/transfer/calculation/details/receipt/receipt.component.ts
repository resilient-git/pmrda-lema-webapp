...
import{ ViewPropertyTransferReceiptModule } from 'app/modules/financial-controller/property/application/transfer/calculation/details/receipt/receipt.module'
@Component({
