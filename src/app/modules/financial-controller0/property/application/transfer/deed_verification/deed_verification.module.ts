...
import { DeedVerificationRoutes } from 'app/modules/financial-controller/property/application/transfer/deed_verification/deed_verification.routing';
...
export class FinancialControllerDeedVerificationTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
