...
import { NewPropertyRoutes } from 'app/modules/citizens/property/add-new/add-new.routing';
...
@NgModule({
    ...
    imports     : [
        RouterModule.forChild(NewPropertyRoutes),
        MatButtonModule,
...
export class CitizensNewPropertyModule
{
