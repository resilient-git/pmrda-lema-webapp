...
//mport { takeUntil } from 'rxapp/modules/citizens/property/properties/list.service
...
export class ListPropertyComponent implements OnInit, OnDestroy
{
     ...
     */
    constructor(
        private _listPropertyService: ListPropertyService,
    ...
    ngOnInit(): void
    {
        ...
        // Get the data
        this._listPropertyService.data$
