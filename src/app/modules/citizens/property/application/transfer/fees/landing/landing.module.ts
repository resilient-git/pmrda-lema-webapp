...
import { LandingRoutes } from 'app/modules/citizens/property/application/transfer/fees/landing/landing.routing';
...
export class CitizensTransferFeesLandingModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
