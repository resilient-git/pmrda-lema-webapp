...
import { InitiateService } from "app/modules/citizens/property/application/transfer/fees/initiate/initiate.service";
...
export class InitiateComponent implements  OnInit, OnDestroy
{
    ...
    ngOnInit(): void     
    {
       ...
       // this.ptcode = this._activatedRoute.params['_value'].ptcode;
        ...
        this._initiateService.getAmount(this.paymentCode)
        .subscribe(() => {
    ...
    proceedToPay():void{
        ...
        document.location.href =this.baseURL+'ccav/tp_fee_requester.php?raw_info='+raw_info;
    }
