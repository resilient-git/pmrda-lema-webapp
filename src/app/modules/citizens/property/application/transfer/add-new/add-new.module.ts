...
import { NewPropertyTransferDetailsRoutes } from 'app/modules/citizens/property/application/transfer/add-new/add-new.routing';
...
@NgModule({
    declarations: [
       // DndDirective,
        //ProgressComponent,
        NewPropertyTransferDetailsComponent
    ],
    imports     : [
        RouterModule.forChild(NewPropertyTransferDetailsRoutes),
        MatButtonModule,
...
export class CitizensPropertyNewTransferModule
{
    id:number;
    first_name:string;
    middle_name:string;
