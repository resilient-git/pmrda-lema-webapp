...
import { TransferStatusService } from 'app/modules/citizens/property/application/transfer/status/status.service';
...
export class TransferStatusComponent implements OnInit, OnDestroy
{
     ...
     */
    constructor(
        private _searchPropertyService: TransferStatusService,
    ...
    //const code = this._activatedRoute.params['_value'].code;
        ...
        .subscribe(() => {
            ...
            this.showAlert = true;
                ...
                //this.property_code.
                //event.click();
                //this.horizontalStepperForm.get('property_code').prop;
                console.log(this.pd)
            }
