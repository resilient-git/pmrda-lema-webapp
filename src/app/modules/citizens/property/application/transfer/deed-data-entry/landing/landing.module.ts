...
import { LandingRoutes } from 'app/modules/citizens/property/application/transfer/deed-data-entrylanding/landing.routing';
...
export class CitizensTransferDeedDataEntryLandingModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
