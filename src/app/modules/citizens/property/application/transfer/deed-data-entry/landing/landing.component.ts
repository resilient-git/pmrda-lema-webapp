...
import { LandingService } from 'app/modules/citizens/property/application/transfer/deed-data-entrylanding/landing.service';
...
import { CitizensTransferDeedDataEntryLandingModule } from "./landing.module";
...
export class LandingComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<CitizensTransferDeedDataEntryLandingModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<CitizensTransferDeedDataEntryLandingModule>;
