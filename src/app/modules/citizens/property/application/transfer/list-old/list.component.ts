...
export class ListPropertyTransferComponent implements OnInit, OnDestroy
{
     ...
     */
    constructor(
        private _ListPropertyTransferService: ListPropertyTransferService,
    ...
    ngOnInit(): void
    {
        ...
        // Get the data
        this._ListPropertyTransferService.data$
