...
import { ListService } from 'app/modules/citizens/property/application/transfer/deed-upload/list/list.service';
...
export class ListComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
   ...
   this.user_id = JSON.parse(localStorage.getItem('currentUser')).id;
    ...
    this._listService.getCitizensPending(this.user_id)
      .subscribe(() => {
  ...
  */
  ...
  processFurther(app_id,status_code):void{
    ...
    if(status_code == 0){
      ...
      this._router.navigateByUrl('/citizens/transfer-application/deed-upload'+app_id);
    }
  }
  // -----------------------------------------------------------------------------------------------------
  // @ Public methods
