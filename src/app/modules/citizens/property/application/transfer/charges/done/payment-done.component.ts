...
export class ChargesPaymentDoneComponent implements OnInit, OnDestroy
{
    ...
    constructor(
        private _transferChargesPaymentDoneService: ChargesPaymentDoneService,
...
import { ChargesPaymentDoneService } from 'app/modules/citizens/payment/charges/done/payment-done.service';
...
export class ChargesPaymentDoneComponent implements OnInit, OnDestroy
{
    ...
    constructor(
        private _paymentDoneService: ChargesPaymentDoneService,
        private _router: Router,
        private _formBuilder: FormBuilder
    )
    {
