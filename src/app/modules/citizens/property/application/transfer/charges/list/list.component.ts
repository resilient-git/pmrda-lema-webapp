...
import { ListService } from 'app/modules/citizens/property/application/transfer/charges/list/list.service';
  ...
  */
  ...
  processFurther(app_id,status_code):void{
    ...
    if(status_code == 0){
      ...
      this._router.navigateByUrl('/citizens/transfer-application/charges/'+app_id);
