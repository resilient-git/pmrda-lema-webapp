...
import { SelectPropertyRoutes } from 'app/modules/citizens/property/application/transfer/select/select.routing';
...
@NgModule({
    ...
    imports     : [
        RouterModule.forChild(SelectPropertyRoutes),
        MatButtonModule,
...
export class CitizensSelectPropertyModule
{
