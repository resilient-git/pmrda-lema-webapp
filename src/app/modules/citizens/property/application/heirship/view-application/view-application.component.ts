    ...
    onOtpChange(value: string[]): void {
      ...
      ngOnInit(): void {
        ...
        if(this.preview_mode =='transfer_application'){
          ...
          this._viewApplicationService.getTransferApplicationReciept(this.transfer_application_id)
            .subscribe(() => {
                if (this._viewApplicationService.data$.source['_value'].status != 200) {
                    ...
                    this.pdfSrc = "http://pmrda.potents.in/api/public/uploads/transfer/application_fees/" + filename;
