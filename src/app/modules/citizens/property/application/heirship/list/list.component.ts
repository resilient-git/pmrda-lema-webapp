...
import { ListService } from 'app/modules/citizens/property/application/heirship/list/list.service';
...
import { CitizensListHeirshipTransferDetailsModule } from "./list.module";
...
export class ListComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<CitizensListHeirshipTransferDetailsModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<CitizensListHeirshipTransferDetailsModule>;
  ...
  */
  ...
  openComposeDialogView(code): void {
    ...
    // const dialogRef = this._matDialog.open(ViewHeirshipComponent, dialogConfig);
  ...
  openComposeDialogDelete(code): void {
    ...
    //     this._listService.deleteHeirship({ code, user_id })
    //       .subscribe((response) => {
