...
import { SelectHeirshipRoutes } from 'app/modules/citizens/property/application/heirship/select/select.routing';

@NgModule({
    declarations: [
        SelectHeirshipComponent
    ],
    imports     : [
        RouterModule.forChild(SelectHeirshipRoutes),
        MatButtonModule,
...
export class CitizensSelectHeirshipModule
{
