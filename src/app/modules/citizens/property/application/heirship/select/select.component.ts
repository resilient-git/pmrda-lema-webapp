...
@Component({
    selector       : 'newheirship',
    templateUrl    : './select.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class SelectHeirshipComponent implements OnInit, OnDestroy
{
     ...
     */
    constructor(
        private _newHeirshipService: SelectHeirshipService,
                ...
                if(this._masterService.data$.source['_value'].property_status == '1'){
                    this._masterService.getPropertyOwnerDataBySadnika(code)
                        ...
                        if(this._masterService.data$.source['value'].status !=200){
                            ...
                            this.horizontalStepperForm.controls.property_code.setValue(this._masterService.data$.source['_value'].data.property_code);                        //    console.log(this._masterService);  
    ...
    send(): void
    {
      console.log(this.horizontalStepperForm);
       ...
       // Sign up
       this._newHeirshipService.postData(this.horizontalStepperForm.value)
           .subscribe((response) => {
            console.log(response);
               ...
               if (response.status != 200) {
                   ...
                   console.log(response);  
                   this._router.navigateByUrl('/citizens/heirship-application/verify-mobile?owner_mobile=' + this.horizontalStepperForm.value['owner_mobile']+"&user_property_id="+response.user_property_id);
