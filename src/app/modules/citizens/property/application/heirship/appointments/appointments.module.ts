...
import { AppointmentsRoutes } from 'app/modules/citizens/property/application/heirship/appointments/appointments.routing';
...
export class CitizensTransferAppointmentModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
