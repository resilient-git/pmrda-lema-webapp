...
import { NewHeirshipTransferDetailsRoutes } from 'app/modules/citizens/property/application/heirship/add-new/add-new.routing';
...
@NgModule({
    declarations: [
       // DndDirective,
        //ProgressComponent,
        NewHeirshipTransferDetailsComponent
    ],
    imports     : [
        RouterModule.forChild(NewHeirshipTransferDetailsRoutes),
        MatButtonModule,
...
export class CitizensHeirshipNewTransferModule
{
}
