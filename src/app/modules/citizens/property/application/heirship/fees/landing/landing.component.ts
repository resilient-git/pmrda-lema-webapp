...
import { LandingService } from 'app/modules/citizens/property/application/heirship/fees/landing/landing.service';
...
import { CitizensTransferFeesLandingModule } from "./landing.module";
...
export class LandingComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<CitizensTransferFeesLandingModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<CitizensTransferFeesLandingModule>;
