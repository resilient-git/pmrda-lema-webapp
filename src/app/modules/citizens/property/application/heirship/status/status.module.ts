...
import { TransferStatusRoutes } from 'app/modules/citizens/property/application/heirship/status/status.routing';
...
@NgModule({
    ...
    imports     : [
        RouterModule.forChild(TransferStatusRoutes),
        MatButtonModule,
...
export class CitizensTransferStatusModule
{
