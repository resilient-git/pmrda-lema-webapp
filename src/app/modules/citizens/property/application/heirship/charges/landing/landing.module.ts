...
import { LandingRoutes } from 'app/modules/citizens/property/application/transfer/charges/landing/landing.routing';
...
export class CitizensTransferChargesLandingModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
