...
export class ListPropertyNominationComponent implements OnInit, OnDestroy
{
     ...
     */
    constructor(
        private _ListPropertyNominationService: ListPropertyNominationService,
    ...
    ngOnInit(): void
    {
        ...
        // Get the data
        this._ListPropertyNominationService.data$
