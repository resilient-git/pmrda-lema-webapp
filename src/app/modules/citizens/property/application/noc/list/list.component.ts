...
export class ListPropertyNocComponent implements OnInit, OnDestroy
{
     ...
     */
    constructor(
        private _ListPropertyNocService: ListPropertyNocService,
    ...
    ngOnInit(): void
    {
        ...
        // Get the data
        this._ListPropertyNocService.data$
