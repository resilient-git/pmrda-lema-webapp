...
import { NewBankNocTransferDetailsRoutes } from './add-new.routing';
...
@NgModule({
    declarations: [
       // DndDirective,
        //ProgressComponent,
        NewBankNocTransferDetailsComponent
    ],
    imports     : [
        RouterModule.forChild(NewBankNocTransferDetailsRoutes),
        MatButtonModule,
...
export class CitizensBankNocNewTransferModule
{
    id:number;
    first_name:string;
    middle_name:string;
