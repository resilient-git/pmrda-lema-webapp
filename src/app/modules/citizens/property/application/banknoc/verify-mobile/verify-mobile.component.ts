...
export class VerifyMobileComponent
{
    ...
    onOtpChange(value: string[]): void {
      ...
      ngOnInit(): void {
        ...
        console.log(this._activatedRoute.snapshot.queryParamMap,"hiiii")
      }

      verifyOtp(): void {
       let params = {user_id: this.user_id, otp: this.otp,user_property_id:this.user_property_id, owner_mobile:this.owner_mobile }
        this._verifyMobileService.validateOtp(params).subscribe((response) => {
          ...
          if (response.status != 200) {
            ...
            this._router.navigateByUrl('/citizens/new-banknoc-application/'+ this.user_property_id);
