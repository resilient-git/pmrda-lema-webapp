...
import { CitizensListBankNocTransferDetailsModule } from "./list.module";
...
export class ListComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<CitizensListBankNocTransferDetailsModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<CitizensListBankNocTransferDetailsModule>;
  ...
  */
  ...
  openComposeDialogView(code): void {
    ...
    // const dialogRef = this._matDialog.open(ViewBankNocComponent, dialogConfig);
  ...
  openComposeDialogDelete(code): void {
    ...
    //     this._listService.deleteBankNoc({ code, user_id })
    //       .subscribe((response) => {
