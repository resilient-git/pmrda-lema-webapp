...
export class DeedVerificationService
{
    ...
    getDeedVerificationDesk2(): Observable<any>
    {
        let url = this.apiEndPoint + 'desk2/transfer-applications/deed-verify-pending';
    ...
    getDeedVerificationDesk21(code): Observable<any>
    {
