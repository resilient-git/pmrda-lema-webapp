...
import { ViewPropertyTransferVerifyRoutes } from 'app/modules/desk2/property/application/transfer/pending/details/verify/verify.routing';
...
@NgModule({
    declarations: [
       // DndDirective,
        //ProgressComponent,
        ViewPropertyTransferVerifyComponent
    ],
    imports     : [
...
export class ViewPropertyTransferVerifyModule
{
    id:number;
    first_name:string;
    middle_name:string;
