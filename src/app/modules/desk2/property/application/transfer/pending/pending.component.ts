...
import { PendingService } from 'app/modules/desk2/property/application/transfer/pending/pending.service';
...
import { Desk2PendingTransferModule } from "./pending.module";
...
export class PendingComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<Desk2PendingTransferModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<Desk2PendingTransferModule>;
  ...
  ngOnInit(): void {
   ...
   let user = cloneDeep(JSON.parse(localStorage.getItem('currentUser')));
    ...
    const code = user.id;
    this._pendingService.getPendingDesk2()
      .subscribe(() => {
