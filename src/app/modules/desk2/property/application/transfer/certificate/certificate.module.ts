...
import { CertificateRoutes } from 'app/modules/desk2/property/application/transfer/certificate/certificate.routing';
...
export class Desk2CertificateTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
