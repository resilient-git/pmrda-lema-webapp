...
import { ViewPropertyTransferActionService } from 'app/modules/desk2/property/application/transfer/certificate/details/action/action.service';
import { MastersService } from 'app/modules/admin/masters/masters.service';
import { FuseAlertType } from '@fuse/components/alert';
import { MatDialog } from '@angular/material/dialog';
import { MatTable, MatTableDataSource } from "@angular/material/table";
import{ ViewPropertyTransferActionModule } from 'app/modules/desk2/property/application/transfer/certificate/details/action/action.module'
@Component({
    ...
    this._viewPropertyTransferActionService.approveDesk2(this.approveForm.value)
        .subscribe((response) => {
            if (response.status != 200) {
               ...
               this._router.navigateByUrl('/desk2/transfer-applications/certificate-pending');
    ...
    this._viewPropertyTransferActionService.rejectDesk2(this.rejectForm.value)
        .subscribe((response) => {
            if (response.status != 200) {
              ...
              this._router.navigateByUrl('/desk2/certificate-transfer-applications');
