...
import { CertificateService } from 'app/modules/desk1/property/application/heirship/certificate/certificate.service';
...
import { Desk1CertificateHeirshipModule } from "./certificate.module";
...
export class CertificateComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<Desk1CertificateHeirshipModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<Desk1CertificateHeirshipModule>;
