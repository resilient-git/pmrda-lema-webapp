...
import { ViewPropertyHeirshipActionService } from 'app/modules/desk1/property/application/heirship/verification_close/details/action/action.service';
import { MastersService } from 'app/modules/admin/masters/masters.service';
import { FuseAlertType } from '@fuse/components/alert';
import { MatDialog } from '@angular/material/dialog';
import { MatTable, MatTableDataSource } from "@angular/material/table";
import{ ViewPropertyHeirshipActionModule } from 'app/modules/desk1/property/application/heirship/verification_close/details/action/action.module'
@Component({
...
export class ViewPropertyHeirshipActionComponent implements OnInit
{
    ...
    ngOnInit(): void
    {
        ...
        this.approveForm = this._formBuilder.group({
            sthalpahani_ahval : ['', Validators.required],
            verification_sheet : ['', Validators.required],
            created_by:[],
            created_at:[] 
          });
  ...
  */
  ...
  if(this.approveForm && this.approveForm.value){
   ...
   // this.propertyHeirshipForm.value.user_property_code = this._activatedRoute.params['_value'].code;
    ...
    this._viewPropertyHeirshipActionService.closeVerification(this.approveForm.value, this.documentData)
        .subscribe((response) => {
            if (response.status != 200) {
               ...
               this._router.navigateByUrl('/desk1/heirship-applications/verification-close-pending');
