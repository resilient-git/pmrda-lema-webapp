...
import{ ViewPropertyHeirshipVerifyConfirmModule } from 'app/modules/desk1/property/application/heirship/verification_close/details/verify/verify.module'
    ...
    this._viewPropertyHeirshipVerifyService.approveDesk1(this.approveForm.value)
        .subscribe((response) => {
            if (response.status != 200) {
               ...
               this._router.navigateByUrl('/desk1/heirship-applications/verification_close-pending');
