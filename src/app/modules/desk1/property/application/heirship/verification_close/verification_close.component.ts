...
import { Desk1VerificationCloseHeirshipModule } from "./verification_close.module";
...
export class VerificationCloseComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<Desk1VerificationCloseHeirshipModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<Desk1VerificationCloseHeirshipModule>;
    ...
    this.__verification_closeService.approveDesk1(this.approveForm.value)
        .subscribe((response) => {
            if (response.status != 200) {
               ...
               this._router.navigateByUrl('/desk1/verification_close-heirship-applications');
