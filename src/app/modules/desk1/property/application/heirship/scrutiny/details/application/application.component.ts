...
import { ViewPropertyHeirshipApplicationService } from 'app/modules/desk1/property/application/heirship/scrutiny/details/application/application.service';
import { MastersService } from 'app/modules/admin/masters/masters.service';
import { FuseAlertType } from '@fuse/components/alert';
import { MatDialog } from '@angular/material/dialog';
import { MatTable, MatTableDataSource } from "@angular/material/table";
import{ ViewPropertyHeirshipApplicationModule } from 'app/modules/desk1/property/application/heirship/scrutiny/details/application/application.module'
@Component({
    ...
    ngOnInit(): void
    {
        ...
        .subscribe(() => {
            if (this._masterService.data$.source['_value'].status != 200) {
                ...
                this.dataSource.data = this.pta.heir;
