...
import { Desk1RejectedHeirshipTransferModule } from "./rejected.module";
...
export class RejectedHeirshipComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<Desk1RejectedHeirshipTransferModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<Desk1RejectedHeirshipTransferModule>;
  ...
  ngOnInit(): void {
   ...
   let user = cloneDeep(JSON.parse(localStorage.getItem('currentUser')));
    ...
    const code = user.id;
    this._rejectedService.getRejectedDesk1()
      .subscribe(() => {
