...
import { ViewHeirshipTransferDocumentModule } from './document.module';
import { ViewHeirshipTransferDocumentService } from './document.service';
@Component({
    selector       : 'ViewHeirshipTransferDocument',
...
export class ViewHeirshipTransferDocumentComponent implements OnInit
{
    ...
    pta : any;
    dataSource: MatTableDataSource<ViewHeirshipTransferDocumentModule> = new MatTableDataSource([]);
    displayedColumns: string[] = ['srno','purchaser_name','documents'];
    /**
     * Constructor
     */
    constructor(
        private _viewHeirshipTransferDocumentService: ViewHeirshipTransferDocumentService,
