...
import { ViewHeirshipTransferApplicationModule } from './application.module';
import { ViewHeirshipTransferApplicationService } from './application.service';
@Component({
    selector       : 'ViewHeirshipTransferApplication',
...
export class ViewHeirshipTransferApplicationComponent implements OnInit
{
    ...
    pta : any;
    dataSource: MatTableDataSource<ViewHeirshipTransferApplicationModule> = new MatTableDataSource([]);
    displayedColumns: string[] = ['id','first_name','middle_name','last_name','email','mobile'];
    /**
     * Constructor
     */
    constructor(
        private _viewHeirshipTransferApplicationService: ViewHeirshipTransferApplicationService,
