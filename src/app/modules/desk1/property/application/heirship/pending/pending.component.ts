...
import { Desk1PendingHeirshipTransferModule } from "./pending.module";
...
export class PendingHeirshipComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<Desk1PendingHeirshipTransferModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<Desk1PendingHeirshipTransferModule>;
  ...
  constructor(
    ...
    private __pendingService:PendingService,
  ...
  this.rejectForm = this._formBuilder.group({
    ...
    this._pendingService.getPendingDesk1()
      .subscribe(() => {
