...
import { PendingHeirshipRoutes } from 'app/modules/desk1/property/application/heirship/pending/pending.routing';
...
@NgModule({
    declarations: [
        PendingHeirshipComponent
    ],
    imports     : [
        RouterModule.forChild(PendingHeirshipRoutes),
        MatButtonModule,
...
export class Desk1PendingHeirshipTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
