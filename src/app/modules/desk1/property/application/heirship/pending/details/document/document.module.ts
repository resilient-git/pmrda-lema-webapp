...
import { ViewHeirshipTransferDocumentRoutes } from './document.routing';
@NgModule({
    declarations: [
       // DndDirective,
        //ProgressComponent,
        ViewHeirshipTransferDocumentComponent
    ],
    imports     : [
        RouterModule.forChild(ViewHeirshipTransferDocumentRoutes),
        MatButtonModule,
...
export class ViewHeirshipTransferDocumentModule
{
    id:number;
    first_name:string;
    middle_name:string;
