...
@Component({
    selector       : 'ViewHeirshipTransferReceipt',
...
export class ViewHeirshipTransferReceiptComponent implements OnInit
{
    ...
    pta : any;
    dataSource: MatTableDataSource<ViewHeirshipTransferReceiptModule> = new MatTableDataSource([]);
    displayedColumns: string[] = ['srno','purchaser_name','receipts'];
    /**
     * Constructor
     */
    constructor(
        private _viewHeirshipTransferReceiptService: ViewHeirshipTransferReceiptService,
