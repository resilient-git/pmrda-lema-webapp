...
import { ViewHeirshipTransferReceiptRoutes } from './receipt.routing';
@NgModule({
    declarations: [
       // DndDirective,
        //ProgressComponent,
        ViewHeirshipTransferReceiptComponent
    ],
    imports     : [
        RouterModule.forChild(ViewHeirshipTransferReceiptRoutes),
        MatButtonModule,
...
export class ViewHeirshipTransferReceiptModule
{
    id:number;
    first_name:string;
    middle_name:string;
