...
import { ViewPropertyHeirshipVerifyService } from 'app/modules/desk1/property/application/heirship/verification/details/verify/verify.service';
import { MastersService } from 'app/modules/admin/masters/masters.service';
import { FuseAlertType } from '@fuse/components/alert';
import { MatDialog } from '@angular/material/dialog';
import { MatTable, MatTableDataSource } from "@angular/material/table";
import{ ViewPropertyHeirshipVerifyConfirmModule } from 'app/modules/desk1/property/application/heirship/verification/details/verify/verify.module'
import {WebcamImage, WebcamInitError, WebcamUtil} from 'ngx-webcam';

@Component({
    selector       : 'ViewPropertyHeirshipVerify',
...
export class ViewPropertyHeirshipVerifyConfirmComponent implements OnInit
{
    ...
    pta : any;
    dataSource: MatTableDataSource<ViewPropertyHeirshipVerifyConfirmModule> = new MatTableDataSource([]);
     ...
     */
    constructor(
        private _viewPropertyHeirshipVerifyService: ViewPropertyHeirshipVerifyService,
...
//btoa
   ...
   // this.propertyHeirshipForm.value.user_property_code = this._activatedRoute.params['_value'].code;
    ...
    this._viewPropertyHeirshipVerifyService.approveDesk1(this.approveForm.value)
        .subscribe((response) => {
            if (response.status != 200) {
               ...
               this._router.navigateByUrl('/desk1/heirship-applications/verification-pending');
