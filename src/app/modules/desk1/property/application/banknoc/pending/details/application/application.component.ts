...
import { ViewBankNocTransferApplicationService } from 'app/modules/desk1/property/application/banknoc/pending/details/application/application.service';
import { MastersService } from 'app/modules/admin/masters/masters.service';
import { FuseAlertType } from '@fuse/components/alert';
import { MatDialog } from '@angular/material/dialog';
import { MatTable, MatTableDataSource } from "@angular/material/table";
import{ ViewBankNocTransferApplicationModule } from 'app/modules/desk1/property/application/banknoc/pending/details/application/application.module'
@Component({
