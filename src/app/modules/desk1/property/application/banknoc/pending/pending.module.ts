...
import { PendingBankNocRoutes } from 'app/modules/desk1/property/application/banknoc/pending/pending.routing';
...
@NgModule({
    declarations: [
        PendingBankNocComponent
    ],
    imports     : [
        RouterModule.forChild(PendingBankNocRoutes),
        MatButtonModule,
...
export class Desk1PendingBankNocTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
