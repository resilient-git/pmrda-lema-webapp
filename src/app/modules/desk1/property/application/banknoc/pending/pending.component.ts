...
import { Desk1PendingBankNocTransferModule } from "./pending.module";
...
export class PendingBankNocComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<Desk1PendingBankNocTransferModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<Desk1PendingBankNocTransferModule>;
