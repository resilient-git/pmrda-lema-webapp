...
import { FileCloseService } from './file_close.service';
...
import { Desk1FileCloseTransferModule } from "./file_close.module";
...
export class FileCloseComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<Desk1FileCloseTransferModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<Desk1FileCloseTransferModule>;
    ...
    this.__file_closeService.approveDesk1(this.approveForm.value)
        .subscribe((response) => {
            if (response.status != 200) {
               ...
               this._router.navigateByUrl('/desk1/file_close-transfer-applications');
