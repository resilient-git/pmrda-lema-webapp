...
import{ ViewBankNoCApplicationModule } from 'app/modules/desk1/property/application/banknoc/scrutiny/details/application/application.module'
@Component({
    selector       : 'ViewBankNoCApplication',
...
export class ViewBankNoCApplicationComponent implements OnInit
{
    ...
    pta : any;
    dataSource: MatTableDataSource<ViewBankNoCApplicationModule> = new MatTableDataSource([]);
    displayedColumns: string[] = ['id','first_name','middle_name','last_name','email','mobile'];
    /**
     * Constructor
     */
    constructor(
        private _viewBankNoCApplicationService: ViewBankNoCApplicationService,
