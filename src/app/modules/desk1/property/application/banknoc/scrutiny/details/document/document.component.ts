...
import{ ViewBankNoCDocumentModule } from 'app/modules/desk1/property/application/banknoc/scrutiny/details/document/document.module'
@Component({
    selector       : 'ViewBankNoCDocument',
...
export class ViewBankNoCDocumentComponent implements OnInit
{
    ...
    pta : any;
    dataSource: MatTableDataSource<ViewBankNoCDocumentModule> = new MatTableDataSource([]);
    displayedColumns: string[] = ['srno','purchaser_name','documents'];
    /**
     * Constructor
     */
    constructor(
        private _viewBankNoCDocumentService: ViewBankNoCDocumentService,
