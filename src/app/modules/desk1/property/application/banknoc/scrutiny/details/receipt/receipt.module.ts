...
import { ViewBankNoCReceiptRoutes } from 'app/modules/desk1/property/application/banknoc/scrutiny/details/receipt/receipt.routing';
...
@NgModule({
    declarations: [
       // DndDirective,
        //ProgressComponent,
        ViewBankNoCReceiptComponent
    ],
    imports     : [
        RouterModule.forChild(ViewBankNoCReceiptRoutes),
        MatButtonModule,
...
export class ViewBankNoCReceiptModule
{
    id:number;
    first_name:string;
    middle_name:string;
