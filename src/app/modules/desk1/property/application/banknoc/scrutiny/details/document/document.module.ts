...
import { ViewBankNoCDocumentRoutes } from 'app/modules/desk1/property/application/banknoc/scrutiny/details/document/document.routing';
...
@NgModule({
    declarations: [
       // DndDirective,
        //ProgressComponent,
        ViewBankNoCDocumentComponent
    ],
    imports     : [
        RouterModule.forChild(ViewBankNoCDocumentRoutes),
        MatButtonModule,
...
export class ViewBankNoCDocumentModule
{
    id:number;
    first_name:string;
    middle_name:string;
