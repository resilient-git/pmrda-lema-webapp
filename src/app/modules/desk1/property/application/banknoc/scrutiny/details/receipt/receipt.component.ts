...
import{ ViewBankNoCReceiptModule } from 'app/modules/desk1/property/application/banknoc/scrutiny/details/receipt/receipt.module'
@Component({
    selector       : 'ViewBankNoCReceipt',
...
export class ViewBankNoCReceiptComponent implements OnInit
{
    ...
    pta : any;
    dataSource: MatTableDataSource<ViewBankNoCReceiptModule> = new MatTableDataSource([]);
    displayedColumns: string[] = ['srno','purchaser_name','receipts'];
    /**
     * Constructor
     */
    constructor(
        private _viewBankNoCReceiptService: ViewBankNoCReceiptService,
