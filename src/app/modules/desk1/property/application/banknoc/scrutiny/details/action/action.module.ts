...
import { ViewBankNoCActionRoutes} from 'app/modules/desk1/property/application/banknoc/scrutiny/details/action/action.routing';
...
@NgModule({
    declarations: [
       // DndDirective,
        //ProgressComponent,
        ViewBankNoCActionComponent
    ],
    imports     : [
        RouterModule.forChild(ViewBankNoCActionRoutes),
        MatButtonModule,
...
export class ViewBankNoCActionModule
{
    id:number;
    first_name:string;
    middle_name:string;
