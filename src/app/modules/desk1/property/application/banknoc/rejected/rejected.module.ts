...
import { RejectedBankNocRoutes } from 'app/modules/desk1/property/application/banknoc/rejected/rejected.routing';
...
@NgModule({
    declarations: [
        RejectedBankNocComponent
    ],
    imports     : [
        RouterModule.forChild(RejectedBankNocRoutes),
        MatButtonModule,
...
export class Desk1RejectedBankNocTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
