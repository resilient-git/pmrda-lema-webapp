...
import { Desk1RejectedBankNocTransferModule } from "./rejected.module";
...
export class RejectedBankNocComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<Desk1RejectedBankNocTransferModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<Desk1RejectedBankNocTransferModule>;
