...
import { DeedDraftRoutes } from 'app/modules/desk1/property/application/transfer/deed_draft/deed_draft.routing';
...
@NgModule({
    ...
    imports     : [
        RouterModule.forChild(DeedDraftRoutes),
        MatButtonModule,
...
export class Desk1DeedDraftTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
