...
import { Desk1TransferDeedPrintingLandingModule } from "./landing.module";
...
export class LandingComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<Desk1TransferDeedPrintingLandingModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<Desk1TransferDeedPrintingLandingModule>;
