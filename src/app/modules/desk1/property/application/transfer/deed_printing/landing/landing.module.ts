...
import { LandingRoutes } from 'app/modules/desk1/property/application/transfer/deed_printinglanding/landing.routing';
...
export class Desk1TransferDeedPrintingLandingModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
