...
import { ListRoutes } from 'app/modules/desk1/property/application/transfer/deed_printing/list/list.routing';
...
export class Desk1ListPropertyTransferDetailsModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
