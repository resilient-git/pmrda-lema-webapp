...
import { ListService } from 'app/modules/desk1/property/application/transfer/deed_printing/list/list.service';
...
import { Desk1ListPropertyTransferDetailsModule } from "./list.module";
...
export class ListComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<Desk1ListPropertyTransferDetailsModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<Desk1ListPropertyTransferDetailsModule>;
  ...
  ngOnInit(): void {
   ...
   let user = cloneDeep(JSON.parse(localStorage.getItem('currentUser')));
    ...
    //const code = user.id;
    this._listService.getDesk1Pending()
      .subscribe(() => {
  ...
  */
  ...
  processFurther(app_id,status_code):void{
    ...
    if(status_code == 0){
      this._router.navigateByUrl('/desk1/new-transfer-application/'+app_id);
    }else if(status_code == 1){
      this._router.navigateByUrl('/desk1/transfer-application/fees/'+app_id);
    }else if(status_code == 21){
      this._router.navigateByUrl('/desk1/transfer-application/deed_printing'+app_id);
    }
  }
  // -----------------------------------------------------------------------------------------------------
  // @ Public methods
