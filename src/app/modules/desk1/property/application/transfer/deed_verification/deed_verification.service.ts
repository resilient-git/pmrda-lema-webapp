...
export class DeedVerificationService
{
    ...
    getDeedVerificationDesk1(): Observable<any>
    {
        let url = this.apiEndPoint + 'desk1/transfer-applications/deed-verify-pending';
    ...
    getDeedVerificationDesk11(code): Observable<any>
    {
