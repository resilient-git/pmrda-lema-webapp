...
import { ViewPropertyTransferApplicationService } from 'app/modules/desk1/property/application/transfer/deed_verification/details/application/application.service';
import { MastersService } from 'app/modules/admin/masters/masters.service';
import { FuseAlertType } from '@fuse/components/alert';
import { MatDialog } from '@angular/material/dialog';
import { MatTable, MatTableDataSource } from "@angular/material/table";
import{ ViewPropertyTransferApplicationModule } from 'app/modules/desk1/property/application/transfer/deed_verification/details/application/application.module'
@Component({
