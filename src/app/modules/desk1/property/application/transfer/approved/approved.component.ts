...
import { Desk1ApprovedTransferModule } from "./approved.module";
...
export class ApprovedComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<Desk1ApprovedTransferModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<Desk1ApprovedTransferModule>;
   ...
   */
  constructor(
    private _approvedService: ApprovedService,
