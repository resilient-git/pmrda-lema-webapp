...
export class DeedGenrateService
{
    ...
    getDeedGenrateDesk1(): Observable<any>
    {
        let url = this.apiEndPoint + 'desk1/transfer-genrate-deed';
    ...
    getDeedGenrateDesk11(code): Observable<any>
    {
