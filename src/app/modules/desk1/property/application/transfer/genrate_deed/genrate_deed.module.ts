...
import { DeedGenrateRoutes } from 'app/modules/desk1/property/application/transfer/genrate_deed/genrate_deed.routing';
...
@NgModule({
    declarations: [
        DeedGenrateComponent
    ],
    imports     : [
        RouterModule.forChild(DeedGenrateRoutes),
        MatButtonModule,
...
export class Desk1DeedGenrateTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
