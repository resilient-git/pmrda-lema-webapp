...
import { Desk1ScrutinyTransferModule } from "./scrutiny.module";
...
export class ScrutinyComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<Desk1ScrutinyTransferModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<Desk1ScrutinyTransferModule>;
