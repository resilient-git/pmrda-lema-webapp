...
import { DeedHandoverRoutes } from 'app/modules/desk1/property/application/transfer/deed_handover/deed_handover.routing';
...
@NgModule({
    declarations: [
        DeedHandoverComponent
    ],
    imports     : [
        RouterModule.forChild(DeedHandoverRoutes),
        MatButtonModule,
...
export class Desk1DeedHandoverTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
