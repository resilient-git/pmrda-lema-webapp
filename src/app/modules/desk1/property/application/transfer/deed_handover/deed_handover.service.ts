...
export class DeedHandoverService
{
    ...
    getDeedHandoverDesk1(): Observable<any>
    {
        let url = this.apiEndPoint + 'desk1/transfer-deed_handover';
    ...
    getDeedHandoverDesk11(code): Observable<any>
    {
