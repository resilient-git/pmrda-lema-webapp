...
import { Desk1RejectedTransferModule } from "./rejected.module";
...
export class RejectedComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<Desk1RejectedTransferModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<Desk1RejectedTransferModule>;
