...
import { Desk1VerificationTransferModule } from "./verification.module";
...
export class VerificationComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<Desk1VerificationTransferModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<Desk1VerificationTransferModule>;
    ...
    this.__verificationService.approveDesk1(this.approveForm.value)
        .subscribe((response) => {
            if (response.status != 200) {
               ...
               this._router.navigateByUrl('/desk1/verification-transfer-applications');
