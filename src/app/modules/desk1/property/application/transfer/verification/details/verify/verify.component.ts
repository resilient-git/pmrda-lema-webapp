...
import{ ViewPropertyTransferVerifyConfirmModule } from 'app/modules/desk1/property/application/transfer/verification/details/verify/verify.module'
    ...
    this._viewPropertyTransferVerifyService.approveDesk1(this.approveForm.value)
        .subscribe((response) => {
            if (response.status != 200) {
               ...
               this._router.navigateByUrl('/clerk/transfer-applications/verification-pending');
