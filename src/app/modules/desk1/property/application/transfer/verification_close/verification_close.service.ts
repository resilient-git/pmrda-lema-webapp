...
export class VerificationCloseService
{
    ...
    getVerificationCloseDesk1(): Observable<any>
    {
        let url = this.apiEndPoint + 'desk1/transfer-verification-close';
    ...
    getVerificationCloseDesk11(code): Observable<any>
    {
