...
export class ViewPropertyTransferActionService
{
    ...
    approveJre(data:any,ahvalData): Observable<any> {
        data['documentData'] = ahvalData;
        let url = this.apiEndPoint + 'jre/approve-site-visit';
        return this._httpClient.post(url, data);
    }
    rejectJre(data:any): Observable<any> {
        let url = this.apiEndPoint + 'jre/reject-site-visit';
        return this._httpClient.post(url, data);
    }
}
