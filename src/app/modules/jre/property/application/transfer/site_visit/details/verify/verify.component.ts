...
import{ ViewPropertyTransferVerifyModule } from 'app/modules/jre/property/application/transfer/pending/details/verify/verify.module'
  ...
  */
  ...
  if(this.approveForm && this.approveForm.value){
   ...
   // this.propertyTransferForm.value.user_property_code = this._activatedRoute.params['_value'].code;
    ...
    this._viewPropertyTransferVerifyService.approveJre(this.approveForm.value)
        .subscribe((response) => {
            if (response.status != 200) {
               ...
               this._router.navigateByUrl('/jre/pending-transfer-applications');
