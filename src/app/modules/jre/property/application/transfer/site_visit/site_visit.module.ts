...
import { SiteVisitRoutes } from 'app/modules/jre/property/application/transfer/site_visit/site_visit.routing';
...
@NgModule({
    ...
    imports     : [
        RouterModule.forChild(SiteVisitRoutes),
        MatButtonModule,
...
export class JreSiteVisitTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
