...
export class DeedVerificationService
{
    ...
    getDeedVerificationJre(): Observable<any>
    {
        let url = this.apiEndPoint + 'jre/transfer-applications/deed-verify-pending';
    ...
    getDeedVerificationJre1(code): Observable<any>
    {
