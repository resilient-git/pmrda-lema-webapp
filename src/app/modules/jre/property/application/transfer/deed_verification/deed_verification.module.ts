...
import { DeedVerificationRoutes } from 'app/modules/jre/property/application/transfer/deed_verification/deed_verification.routing';
...
export class JreDeedVerificationTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
