...
import { CertificateRoutes } from 'app/modules/desk5/property/application/transfer/certificate/certificate.routing';
...
export class Desk5CertificateTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
