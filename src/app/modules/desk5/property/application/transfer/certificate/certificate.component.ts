...
import { CertificateService } from 'app/modules/desk5/property/application/transfer/certificate/certificate.service';
...
import { Desk5CertificateTransferModule } from "./certificate.module";
...
export class CertificateComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<Desk5CertificateTransferModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<Desk5CertificateTransferModule>;
