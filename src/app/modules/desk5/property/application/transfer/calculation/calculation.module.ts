...
import { CalculationRoutes } from 'app/modules/desk5/property/application/transfer/calculation/calculation.routing';
...
export class Desk5CalculationTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
