...
import { Desk5VerificationBankNocRoutes } from './verification.routing';
...
@NgModule({
    declarations: [
        Desk5VerificationBankNocComponent
    ],
    imports     : [
        RouterModule.forChild(Desk5VerificationBankNocRoutes),
        MatButtonModule,
...
export class Desk5VerificationBankNocTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
