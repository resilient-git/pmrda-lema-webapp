...
import { PendingService } from 'app/modules/desk5/property/application/transfer/pending/pending.service';
...
import { Desk5PendingTransferModule } from "./pending.module";
...
export class PendingComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<Desk5PendingTransferModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<Desk5PendingTransferModule>;
  ...
  ngOnInit(): void {
   ...
   let user = cloneDeep(JSON.parse(localStorage.getItem('currentUser')));
    ...
    const code = user.id;
    this._pendingService.getPendingDesk5()
      .subscribe(() => {
