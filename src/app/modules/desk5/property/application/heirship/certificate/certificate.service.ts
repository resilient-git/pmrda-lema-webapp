...
export class CertificateService
{
    ...
    getCertificateDesk5(): Observable<any>
    {
        let url = this.apiEndPoint + 'desk5/heirship-applications/certificate-pending';
    ...
    getCertificateDesk51(code): Observable<any>
    {
        
        let url = this.apiEndPoint + 'properties/list';
       // let url = this.apiEndPoint + 'desk5/heirship-applications/'+code;
        return this._httpClient.get(url).pipe(
            tap((response: any) => {
                this._data.next(response);
