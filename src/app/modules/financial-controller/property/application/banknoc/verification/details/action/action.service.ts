...
export class ViewBankNocTransferActionService
{
    ...
    verifyFinancialController(data:any): Observable<any> {
        let url = this.apiEndPoint + 'financial-controller/verify-banknoc-application';
        return this._httpClient.post(url, data);
    }
