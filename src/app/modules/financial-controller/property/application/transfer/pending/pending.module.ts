...
import { PendingRoutes } from 'app/modules/financial-controller/property/application/transfer/pending/pending.routing';
...
export class FinancialControllerPendingTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
