...
import { ViewPropertyTransferApplicationService } from 'app/modules/financial-controller/property/application/transfer/deed_verification/details/application/application.service';
import { MastersService } from 'app/modules/admin/masters/masters.service';
import { FuseAlertType } from '@fuse/components/alert';
import { MatDialog } from '@angular/material/dialog';
import { MatTable, MatTableDataSource } from "@angular/material/table";
import{ ViewPropertyTransferApplicationModule } from 'app/modules/financial-controller/property/application/transfer/deed_verification/details/application/application.module'
@Component({
    selector       : 'ViewPropertyTransferApplication',
...
export class ViewPropertyTransferApplicationComponent implements OnInit
{
    ...
    pta : any;
    dataSource: MatTableDataSource<ViewPropertyTransferApplicationModule> = new MatTableDataSource([]);
    displayedColumns: string[] = ['id','first_name','middle_name','last_name','email','mobile'];
    /**
     * Constructor
     */
    constructor(
        private _viewPropertyTransferApplicationService: ViewPropertyTransferApplicationService,
