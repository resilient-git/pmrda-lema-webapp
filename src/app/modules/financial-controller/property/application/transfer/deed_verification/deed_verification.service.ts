...
export class DeedVerificationService
{
    ...
    getDeedVerificationFinancialController(): Observable<any>
    {
        let url = this.apiEndPoint + 'financial-controller/transfer-applications/deed-verify-pending';
    ...
    getDeedVerificationFinancialController1(code): Observable<any>
    {
