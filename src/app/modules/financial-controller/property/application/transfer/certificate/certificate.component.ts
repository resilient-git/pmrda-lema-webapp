...
import { CertificateService } from 'app/modules/financial-controller/property/application/transfer/certificate/certificate.service';
...
import { FinancialControllerCertificateTransferModule } from "./certificate.module";
...
export class CertificateComponent implements OnInit, OnDestroy {
  ...
  dataSource: MatTableDataSource<FinancialControllerCertificateTransferModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<FinancialControllerCertificateTransferModule>;
    ...
    this.__certificateService.approveFinancialController(this.approveForm.value)
        .subscribe((response) => {
            if (response.status != 200) {
               ...
               this._router.navigateByUrl('/financial-controller/certificate-transfer-applications');
