...
import { CertificateRoutes } from 'app/modules/financial-controller/property/application/transfer/certificate/certificate.routing';
...
export class FinancialControllerCertificateTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
