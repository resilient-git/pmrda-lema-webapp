...
import { CalculationRoutes } from 'app/modules/financial-controller/property/application/transfer/calculation/calculation.routing';
...
export class FinancialControllerCalculationTransferModule
{
    owner_name:string;
    owner_mobile:number;
    uprn:number;
