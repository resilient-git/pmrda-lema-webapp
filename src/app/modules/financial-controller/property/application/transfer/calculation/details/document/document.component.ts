...
import { ViewPropertyTransferDocumentService } from 'app/modules/financial-controller/property/application/transfer/calculation/details/document/document.service';
import { MastersService } from 'app/modules/admin/masters/masters.service';
import { FuseAlertType } from '@fuse/components/alert';
import { MatDialog } from '@angular/material/dialog';
import { MatTable, MatTableDataSource } from "@angular/material/table";
import{ ViewPropertyTransferDocumentModule } from 'app/modules/financial-controller/property/application/transfer/calculation/details/document/document.module'
@Component({
    selector       : 'ViewPropertyTransferDocument',
...
export class ViewPropertyTransferDocumentComponent implements OnInit
{
    ...
    dataSourceAttendee: MatTableDataSource<ViewPropertyTransferDocumentModule> = new MatTableDataSource([]);
    displayedColumnsAttendee: string[] = ['srno','attendee_name','photo'];
    dataSource: MatTableDataSource<ViewPropertyTransferDocumentModule> = new MatTableDataSource([]);
     ...
     */
    constructor(
        private _viewPropertyTransferDocumentService: ViewPropertyTransferDocumentService,
