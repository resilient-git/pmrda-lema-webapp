...
export class CalculationService
{
    ...
    getCalculationFinancialController(): Observable<any>
    {
        let url = this.apiEndPoint + 'financial-controller/transfer-calculation';
    ...
    getCalculationFinancialController1(code): Observable<any>
    {
