...
import { ListService } from 'app/modules/admin/masters/building-number/list/list.service';
import { FormBuilder, FormGroup, Validators } from "@angular/forms";
import { MatPaginator } from "@angular/material/paginator";
import { MatSort } from "@angular/material/sort";
import { MatTable, MatTableDataSource } from "@angular/material/table";
import { MatDialog, MatDialogRef } from "@angular/material/dialog";
import { AddNewComponent } from 'app/modules/admin/masters/building-number/add-new/add-new.component';
import { DeleteComponent } from 'app/modules/admin/masters/building-number/delete/delete.component';
import { EditComponent } from 'app/modules/admin/masters/building-number/edit/edit.component';
import { ViewComponent } from 'app/modules/admin/masters/building-number/view/view.component';
import { FuseAlertType } from "@fuse/components/alert";
import { MastersBuildingNumberListModule } from "./list.module";
...
export class ListComponent implements OnInit, OnDestroy
{
  ...
  displayedColumns: string[] = ['taluka_code', 'taluka', 'village_code', 'village', 'gpsc_number','scheme_number','society','building_number','actions'];
  ...
  dataSource: MatTableDataSource<MastersBuildingNumberListModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<MastersBuildingNumberListModule>;
