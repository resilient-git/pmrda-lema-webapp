...
import { ListService } from 'app/modules/admin/masters/sadnika-dukan-number/list/list.service';
...
import { ViewComponent } from 'app/modules/admin/masters/sadnika-dukan-number/view/view.component';
import { FuseAlertType } from "@fuse/components/alert";
import { MastersSadnikanumberListModule } from "./list.module";
...
export class ListComponent implements OnInit, OnDestroy {
  ...
  displayedColumns: string[] = ['taluka_code', 'taluka', 'village_code', 'village', 'gpsc_number', 'scheme_number', 'society', 'building_number', 'sadnika_number', 'actions'];
  ...
  dataSource: MatTableDataSource<MastersSadnikanumberListModule> = new MatTableDataSource([]);

  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<MastersSadnikanumberListModule>;
