...
import { ListRoutes } from 'app/modules/admin/masters/bulkland-number/list/list.routing';
...
export class MastersBulkLandNumberListModule
{
    ...
    date_of_possession: string;
    special_land_acquition_officer_number: number;
    award_number: number;
    is_developed : string;
    aminity_code: number;
    other_aminity: string;
    is_aminity_allocated: string;
