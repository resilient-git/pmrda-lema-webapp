...
import { EditPropertyRoutes } from 'app/modules/admin/properties/edit/edit.routing';
...
@NgModule({
    ...
    imports     : [
        RouterModule.forChild(EditPropertyRoutes),
        MatButtonModule,
...
export class AdminEditPropertyModule
{
}
