...
import { ViewPropertyRoutes } from 'app/modules/admin/property-owner/view/view.routing';
...
@NgModule({
    ...
    imports     : [
        RouterModule.forChild(ViewPropertyRoutes),
        MatButtonModule,
...
export class ViewPropertyOwnerModule
{
}
